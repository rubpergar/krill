...
| `GET` | `/privacidad` | — | `200` HTML informativo | Aviso público básico sobre tratamiento de datos del formulario. |
...
- GET /privacidad es público y no requiere autenticación.
