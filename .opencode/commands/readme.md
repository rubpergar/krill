---
description: Generar o sobrescribir el README.md del proyecto
---
...
- Detecta el stack tecnológico, el propósito del proyecto y las características principales del código existente.
...
- No incluyas contenido placeholder o de ejemplo que no refleje el estado real del proyecto.

Flujo:
1. Inspecciona la estructura del proyecto, archivos de paquete, código fuente y archivos de configuración.
2. Identifica el stack tecnológico, propósito y características principales.
