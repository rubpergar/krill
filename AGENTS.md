...
| C++/Qt Best Practices | `agents/skills/cpp-best-practices/SKILL.md` | Generating, modifying, refactoring, or reviewing C++/Qt code for performance, resource usage, safety, or maintainability in C++/Qt repositories (peticiones_qmonitor, qmonitor, qthinc, nodovirtual) | Non-C++ repositories, business-logic debugging without C++ scope, or replacing the security-review skill |
