...
- Domain: Inventory management / small business operations
- Users: Office staff (internal tool)
- Goal: Basic CRUD web application for managing products, categories, and stock levels

## Stack
- Runtime/framework: Node.js / Hono
...
|---|---|---|
| Install | `pnpm install` | Package manager and lockfile policy |
| Dev server | `pnpm dev` | Port and env requirements |
